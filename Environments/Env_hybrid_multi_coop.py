...
class car:
    ...
    def __init__(self, car_b, ped_b, cross, lines, dt, speed_limit, line, exist=True):#, speed_ped_list, pos_ped_list):
        #self.seed(seed)
        self.car_b = car_b
        self.dt=dt
        self.cross=cross
    ...
    def get_data(self):
        if(not self.exist):# j ai rajoute
            return [0., 0., 0., 0., 0, self.line]
...
class Crosswalk_hybrid_multi_coop(gym.Env):
    """Custom Environment that follows gym interface"""
    metadata = {'render.modes': ['human']}
    """
        Crosswalk_hybrid_multi_coop: creation of the environment
        :param dt: step time
    ...
    def __init__(self, car_b, ped_b, cross_b, nb_car, nb_ped, nb_lines, dt, max_episode, simulation="unif"):
        super(Crosswalk_hybrid_multi_coop, self).__init__()
        #self.seed()
        self.viewer = False
        self.window = None
