            ...
            # Pedestrian in crosswalk
                ...
                # The pedestrian walks
                    ...
                    if(self.stop):
                        ...
                        self.time_stop = random.randint(2, 15)
...
class Crosswalk_hybrid_multi_stop(gym.Env):
    """Custom Environment that follows gym interface"""
    metadata = {'render.modes': ['human']}
    """
        Crosswalk_hybrid_multi_stop: creation of the environment
        :param dt: step time
    ...
    def __init__(self, car_b, ped_b, cross_b, nb_car, nb_ped, nb_lines, dt, max_episode, simulation="unif"):
        super(Crosswalk_hybrid_multi_stop, self).__init__()
        #self.seed()
        self.viewer = False
        self.window = None
